...
Route::prefix('profile/')->middleware(['auth'])->group(function () {
    ...
    Route::get('/profile/courses', [CourseController::class, 'courses'])->name('front.user.courses');
...
Route::prefix('course/')->middleware(['auth'])->group(function (){
    ...
    Route::post('/task/{task}', [\App\Http\Controllers\Admin\TaskController::class, 'checkTask'])->name('front.check_task');
});
