    ...
    <div class="card-body">
        ...
        <div class="row mb-4">
            <div class="col-sm-6 mb-sm-0 mb-3 d-flex">
                ...
                <div>
                    <span>{{ __('vars.start_day') }}</span>
                    <p class="mb-0 pt-1 font-w500 text-black">{{ $user_progress->created_at }}</p>
                </div>
            </div>
            <div class="col-sm-6 d-flex">
                ...
                <div>
                    <span>{{ __('vars.last_update') }}</span>
                    <p class="mb-0 pt-1 font-w500 text-black">{{ $user_progress->updated_at }}</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                ...
                <!--TODO tasks counter-->
                <div>{{ __('vars.tasks_done') }}:<span class="text-black ms-3 font-w600">{{ $user_progress->data['tasks'] ?? 0 }}</span></div>
            </div>
